...
const s=StyleSheet.create({
 ...
 navItem:{flex:1,alignItems:'center',justifyContent:'center',gap:3},navText:{color:C.mutedStrong,fontFamily:F.semiBold,fontSize:8},navActive:{color:C.lime},
