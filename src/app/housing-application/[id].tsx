...
const s=StyleSheet.create({
 ...
 statusRow:{flexDirection:'row',justifyContent:'space-between',alignItems:'center'},status:{color:C.lime,fontFamily:F.extraBold,fontSize:8,letterSpacing:.8},
 ...
 secondary:{height:46,borderWidth:1,borderColor:C.borderStrong,alignItems:'center',justifyContent:'center',marginTop:9},secondaryText:{color:C.mutedStrong,fontFamily:F.extraBold,fontSize:8,letterSpacing:.8},
