...
export default function JobDetail(){
 ...
 <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
  ...
  <Pressable onPress={()=>openGoogleMaps(location+' '+job.company_name)}><Text style={s.location}>{location||'Location not listed'}  ↗</Text></Pressable>
  ...
  {job.pay_min!=null?<View style={s.fact}><Text style={s.factLabel}>PAY</Text><Text style={s.factValue}>{'$'+Number(job.pay_min).toLocaleString()+(job.pay_max?' – $'+Number(job.pay_max).toLocaleString():'')+' / '+(job.pay_period||'period')}</Text></View>:null}
