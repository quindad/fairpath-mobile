...
export default function HousingDetail(){
 ...
 async function openUrl(url:string|null){
  if(!url)return;
  try{await Linking.openURL(url)}catch{notify('Link unavailable','We could not open this link.')}
 }
