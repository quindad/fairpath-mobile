 ...
 return <View style={styles.screen}><StatusBar style="light"/><SafeAreaView style={styles.safe}>
   ...
   <View style={[styles.frame,desktop&&styles.frameDesktop]}>
     ...
     <View style={styles.actions}>
       <Pressable style={styles.primary} onPress={()=>router.push('/sign-up')} accessibilityRole="button"><Text style={styles.primaryText}>Get started</Text><View style={styles.arrowBox}><Text style={styles.arrow}>→</Text></View></Pressable>
       <Pressable style={styles.secondary} onPress={()=>router.push('/sign-in')} accessibilityRole="button"><Text style={styles.secondaryText}>I already have an account</Text></Pressable>
...
const styles=StyleSheet.create({
 ...
 arrowBox:{width:46,height:46,alignItems:'center',justifyContent:'center'},arrow:{color:BLACK,fontSize:28,lineHeight:30},
