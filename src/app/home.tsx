 ...
 return <View style={s.screen}><StatusBar style="light"/><SafeAreaView style={s.safe}>
  ...
  <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
   ...
   <Pressable style={s.readiness} onPress={()=>router.push('/profile-readiness' as never)}>
    <View style={s.readinessTop}><View><Text style={s.readinessKicker}>FAIRPATH READINESS</Text><Text style={s.readinessTitle}>Complete your profile</Text></View><Text style={s.readinessPercent}>32%</Text></View>
    <View style={s.track}><View style={[s.fill,{width:'32%'}]}/></View>
