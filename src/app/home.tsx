...
const s=StyleSheet.create({
 ...
 top:{height:58,flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginBottom:16},profile:{height:32,minWidth:42,borderRadius:16,borderWidth:1,borderColor:C.borderStrong,alignItems:'center',justifyContent:'center'},profileText:{color:C.white,fontFamily:F.extraBold,fontSize:9,letterSpacing:1},
